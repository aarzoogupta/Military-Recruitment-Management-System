...
def join():
    ...
    img_j=PhotoImage(file="join_s.png")
    join_img=PhotoImage(file="join.png")
    ...
    def check2():
        ...
        img4=PhotoImage(file="log_dtail.png")
...
def train():
    ...
    img2=PhotoImage(file="login.png")
...
def user_win():
    ...
    img6=PhotoImage(file="user_win.png")
...
def personnel():
    ...
    phot=PhotoImage(file="m_winph.png")
...
def ask_pass(n):
    ...
    prot_ph=PhotoImage(file="prot_pass.png")
...
def update_n():
    ...
    img9=PhotoImage(file="black_win.png")
...
def enter_army(post):
    ...
    global img8
    img8=PhotoImage(file="army_log.png")
    main_winn.lift()
...
def login_ar():
    ...
    img10=PhotoImage(file="army_log.png")
...
def arm_page():
    ...
    img6=PhotoImage(file="Pers_2.png")
    ...
    img7=PhotoImage(file="Pers_3.png")
...
def table_show(total_rows,total_columns):
    ...
    photo_w=PhotoImage(file="join.png")
...
def make_entry():
    ...
    photo_w2=PhotoImage(file="join.png")
...
cur.execute("create table IF NOT EXISTS shops(shop_id varchar(5) primary key not null, shop_name varchar(20), shop_owner varchar(13), date_of_opening date)")
cur.execute("insert into shops values('A12','BATA','RAJEEV','2022-02-01')")
cur.execute("insert into shops values('A13','VENUS STEPS','KAVITA','2021-02-14')")
